...
function [] = drawSkeleton(jointIndexMap,points, frameNum)
    
    yIndex = 2*frameNum;%because points has x and y in separate columns
    
    figure
    p =plot(points(:,yIndex-1),points(:,yIndex),'y.','MarkerSize',15);%plot joints
   % hold on
    line([points(jointIndexMap('Head'),yIndex-1) points(jointIndexMap('Neck'),yIndex-1)], ...
            [points(jointIndexMap('Head'),yIndex) points(jointIndexMap('Neck'),yIndex)]);
        
    line([points(jointIndexMap('SpineShoulder'),yIndex-1) points(jointIndexMap('Neck'),yIndex-1)], ...
            [points(jointIndexMap('SpineShoulder'),yIndex) points(jointIndexMap('Neck'),yIndex)]);
    
    line([points(jointIndexMap('SpineShoulder'),yIndex-1) points(jointIndexMap('SpineMid'),yIndex-1)], ...
            [points(jointIndexMap('SpineShoulder'),yIndex) points(jointIndexMap('SpineMid'),yIndex)]);
     
    line([points(jointIndexMap('SpineBase'),yIndex-1) points(jointIndexMap('SpineMid'),yIndex-1)], ...
            [points(jointIndexMap('SpineBase'),yIndex) points(jointIndexMap('SpineMid'),yIndex)]);
     
    line([points(jointIndexMap('SpineBase'),yIndex-1) points(jointIndexMap('HipRight'),yIndex-1)], ...
            [points(jointIndexMap('SpineBase'),yIndex) points(jointIndexMap('HipRight'),yIndex)]);
     
    line([points(jointIndexMap('SpineBase'),yIndex-1) points(jointIndexMap('HipLeft'),yIndex-1)], ...
            [points(jointIndexMap('SpineBase'),yIndex) points(jointIndexMap('HipLeft'),yIndex)]);
     
    line([points(jointIndexMap('SpineShoulder'),yIndex-1) points(jointIndexMap('ShoulderRight'),yIndex-1)], ...
            [points(jointIndexMap('SpineShoulder'),yIndex) points(jointIndexMap('ShoulderRight'),yIndex)]);
    
    line([points(jointIndexMap('SpineShoulder'),yIndex-1) points(jointIndexMap('ShoulderLeft'),yIndex-1)], ...
            [points(jointIndexMap('SpineShoulder'),yIndex) points(jointIndexMap('ShoulderLeft'),yIndex)]);
     
    line([points(jointIndexMap('KneeRight'),yIndex-1) points(jointIndexMap('HipRight'),yIndex-1)], ...
            [points(jointIndexMap('KneeRight'),yIndex) points(jointIndexMap('HipRight'),yIndex)]);
     
    line([points(jointIndexMap('KneeRight'),yIndex-1) points(jointIndexMap('AnkleRight'),yIndex-1)], ...
            [points(jointIndexMap('KneeRight'),yIndex) points(jointIndexMap('AnkleRight'),yIndex)]);
    
    line([points(jointIndexMap('FootRight'),yIndex-1) points(jointIndexMap('AnkleRight'),yIndex-1)], ...
            [points(jointIndexMap('FootRight'),yIndex) points(jointIndexMap('AnkleRight'),yIndex)]);
    
    
    line([points(jointIndexMap('KneeLeft'),yIndex-1) points(jointIndexMap('HipLeft'),yIndex-1)], ...
            [points(jointIndexMap('KneeLeft'),yIndex) points(jointIndexMap('HipLeft'),yIndex)]);
     
    line([points(jointIndexMap('KneeLeft'),yIndex-1) points(jointIndexMap('AnkleLeft'),yIndex-1)], ...
            [points(jointIndexMap('KneeLeft'),yIndex) points(jointIndexMap('AnkleLeft'),yIndex)]);
    
    line([points(jointIndexMap('FootLeft'),yIndex-1) points(jointIndexMap('AnkleLeft'),yIndex-1)], ...
            [points(jointIndexMap('FootLeft'),yIndex) points(jointIndexMap('AnkleLeft'),yIndex)]);
