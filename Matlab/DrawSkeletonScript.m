...
%line([(424-bodyMatrix(jointIndexMap('FootLeft'),yIndex-1)) (512-bodyMatrix(jointIndexMap('AnkleLeft'),yIndex-1))], ...
  %      [(424-bodyMatrix(jointIndexMap('FootLeft'),yIndex)) (512-bodyMatrix(jointIndexMap('AnkleLeft'),yIndex))]);
